...
var TopDownAdvGame = (function () {
    function TopDownAdvGame() {
        this.game = new Phaser.Game(800, 600, Phaser.AUTO, 'content', { preload: this.preload, create: this.create, update: this.update });
    }
    TopDownAdvGame.prototype.preload = function () {
    ...
    TopDownAdvGame.prototype.create = function () {
    ...
    TopDownAdvGame.prototype.update = function () {
    ...
    return TopDownAdvGame;
})();
window.onload = function () {
    var game = new TopDownAdvGame();
};
//# sourceMappingURL=top-down.js.map